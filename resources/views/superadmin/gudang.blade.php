                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-success btn-edit-management"><i
                                                    class="fa fa-edit">
                                                    Ubah</i></button> &nbsp;
                                            <a href="{{ route('superadmin.deleteGudang', $value->id) }}"><button
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Tambah Data Divisi</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('superadmin.addGudang') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-form-edit-management" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Form Ubah Data Divisi</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('superadmin.updateGudang') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
